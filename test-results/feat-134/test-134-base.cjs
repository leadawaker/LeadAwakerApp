...
async function main() {
  ...
  await page.goto('http://localhost:5173/agency/conversations');
  await page.waitForTimeout(2000);

  // Take screenshot of mobile view
  await page.screenshot({ path: '/home/gabriel/docker/code-server/config/workspace/LeadAwakerApp/test-results/conv-1.png', fullPage: false });
  ...
  await page.screenshot({ path: '/home/gabriel/docker/code-server/config/workspace/LeadAwakerApp/test-results/conv-2.png', fullPage: false });
  ...
  await page.screenshot({ path: '/home/gabriel/docker/code-server/config/workspace/LeadAwakerApp/test-results/conv-3.png', fullPage: false });
  ...
  if (isBottomMenuVisible) {
    ...
    await page.screenshot({ path: '/home/gabriel/docker/code-server/config/workspace/LeadAwakerApp/test-results/conv-4.png', fullPage: false });
  ...
  await page.screenshot({ path: '/home/gabriel/docker/code-server/config/workspace/LeadAwakerApp/test-results/conv-5-desktop.png', fullPage: false });

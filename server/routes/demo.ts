...
export function registerDemoRoutes(app: Express): void {
  ...
  const adminSchema = z.object({
    ...
    service: z.enum(["dbr", "quote", "speed", "widget", "voice", "reputation", "socials"]).optional(),
  ...
  app.post(
    ...
    wrapAsync(async (req, res) => {
      ...
      if (service === "socials" && !clientNiche) {
  ...
  const WEB_DEMO_SUFFIXES = new Set(["", "message", "restart", "recap", "bump", "voice", "audio", "review-draft"]);

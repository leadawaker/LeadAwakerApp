...
This command **requires** the project directory as an argument via `/home/gabriel/LeadAwakerApp`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/home/gabriel/LeadAwakerApp/.autoforge/prompts/app_spec.txt` and `/home/gabriel/LeadAwakerApp/.autoforge/prompts/initializer_prompt.md`

If `/home/gabriel/LeadAwakerApp` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/home/gabriel/LeadAwakerApp/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/home/gabriel/LeadAwakerApp/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/home/gabriel/LeadAwakerApp/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/home/gabriel/LeadAwakerApp/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/home/gabriel/LeadAwakerApp/.autoforge/prompts/`!
>
> **Files created:**
> - `/home/gabriel/LeadAwakerApp/.autoforge/prompts/app_spec.txt`
> - `/home/gabriel/LeadAwakerApp/.autoforge/prompts/initializer_prompt.md`
>

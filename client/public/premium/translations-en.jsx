...
window.TRANSLATIONS.en = {
  ...
  cta: {
    ...
    h2_l3: "We'll take it",
    h2_italic: "from here.",
    body: "Five partner businesses at a time. Send a short introduction below",
    note: "Engagements typically suit businesses doing €1M+ in annual project revenue.",
    ph_name: "Your name",
    ph_email: "Email",
    ph_describe: "Describe your business.",
    btn_send: "Send introduction",

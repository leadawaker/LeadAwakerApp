...
const NICHE_ICONS = {
  ...
  coach:       <svg viewBox="0 0 18 18" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M2 7 9 3.5 16 7 9 10.5 2 7Z"/><path d="M5.5 8.7v3c0 1 1.5 2 3.5 2s3.5-1 3.5-2v-3"/><path d="M16 7v4"/></svg>,

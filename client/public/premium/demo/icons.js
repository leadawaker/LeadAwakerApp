...
var ICONS = {
  ...
  // The two restart scenarios, in the popover. A priced document for the lead
  // who already holds a quote, an unanswered question for the one who never
  // got one: the two labels differ by a single word, and the glyph separates
  // them before the sentence is read.
  ...
  // Presenter panel trigger. Circles rather than a hamburger: ☰ promises
  // navigation, and this page has none.

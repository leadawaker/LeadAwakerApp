...
ok("August has 31 cells", (cal.match(/class="cal-d(?: is-pick)?"/g) || []).length === 31);
...
ok("leap February has 29 days", (summaryHtml(SUM, { year: 2028, month: 2, day: 29, time: "9:00" }).match(/class="cal-d(?: is-pick)?"/g) || []).length === 29);
ok("non-leap February has 28", (summaryHtml(SUM, { year: 2026, month: 2, day: 2, time: "9:00" }).match(/class="cal-d(?: is-pick)?"/g) || []).length === 28);

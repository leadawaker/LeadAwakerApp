      ...
      >
        ...
        <div 
          ...
          style={{
            ...
            background: "linear-gradient(135deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.95) 100%), linear-gradient(to right, rgba(0,61,153,0.02) 0%, transparent 50%)"
          }}
          data-testid="chat-3d-card"
        >
          {/* Cool glow effect */}
          <div className="absolute inset-0 pointer-events-none" style={{
            background: "radial-gradient(circle at 20% 50%, rgba(0,61,153,0.05) 0%, transparent 40%)",
          }} />
          
          {/* Chat Header */}
          <div className="p-4 flex items-center gap-3" style={{ backgroundColor: "#003D99" }}>
            ...
            <div className="relative z-10 space-y-4">
              ...
              <motion.div className="flex justify-end" custom={0} initial="hidden" whileInView="visible" variants={messageVariants} viewport={{ once: true, margin: "-100px" }} data-testid="message-sophie-1">
                <div className="flex flex-col items-end gap-1">
                  <div className="text-white rounded-2xl rounded-tr-sm px-4 py-3 max-w-[85%] shadow-sm text-sm" style={{ backgroundColor: "#003D99" }}>
              ...
              <motion.div className="flex justify-end" custom={4} initial="hidden" whileInView="visible" variants={messageVariants} viewport={{ once: true, margin: "-100px" }} data-testid="message-sophie-3">
                <div className="flex flex-col items-end gap-1">
                  <div className="text-white rounded-2xl rounded-tr-sm px-4 py-3 max-w-[85%] shadow-sm text-sm" style={{ backgroundColor: "#0052FF" }}>

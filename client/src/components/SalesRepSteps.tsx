...
export const SalesRepSteps = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-violet-400/40 via-[65%] to-cyan-600" />
      <div className="absolute inset-0 bg-gradient-to-b from-slate-950/80 via-transparent via-[65%] to-cyan-600/20 mix-blend-multiply" />

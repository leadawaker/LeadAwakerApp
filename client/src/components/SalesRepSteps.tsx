  ...
  return (
    ...
    >
      <div 
        ...
        style={{
          backgroundImage: `radial-gradient(circle at 23% 45%, white 0.75px, transparent 0.75px),
                            radial-gradient(circle at 68% 12%, white 1.5px, transparent 1.5px),
                            radial-gradient(circle at 42% 28%, white 1px, transparent 1px),
                            radial-gradient(circle at 85% 52%, white 1px, transparent 1px),
                            radial-gradient(circle at 15% 61%, white 0.75px, transparent 0.75px),
                            radial-gradient(circle at 72% 38%, white 1px, transparent 1px),
                            radial-gradient(circle at 38% 8%, white 0.75px, transparent 0.75px),
                            radial-gradient(circle at 91% 71%, white 1px, transparent 1px)`,
      ...
      <div 
        className="absolute inset-0" 
        style={{
          backgroundImage: `radial-gradient(circle at 57% 22%, #e8e8e8 1.25px, transparent 1.25px),
                            radial-gradient(circle at 29% 15%, white 1px, transparent 1px),
                            radial-gradient(circle at 76% 55%, white 0.75px, transparent 0.75px),
                            radial-gradient(circle at 11% 67%, #e8e8e8 1.875px, transparent 1.875px),
                            radial-gradient(circle at 64% 79%, white 0.75px, transparent 0.75px),
                            radial-gradient(circle at 47% 45%, #f0f0f0 1.25px, transparent 1.25px),
                            radial-gradient(circle at 85% 8%, #e8e8e8 1.25px, transparent 1.25px),
                            radial-gradient(circle at 36% 88%, #f0f0f0 1.25px, transparent 1.25px)`,
          backgroundRepeat: 'repeat',
          backgroundSize: '450px 380px',
          filter: 'drop-shadow(0 0 12px rgba(255,255,255,0.6)) drop-shadow(0 0 6px rgba(255,255,255,0.4))',
      ...
      <div 
        className="absolute inset-0" 
        style={{
          backgroundImage: `radial-gradient(circle at 19% 19%, white 0.75px, transparent 0.75px),
                            radial-gradient(circle at 73% 33%, #f0f0f0 1.875px, transparent 1.875px),
                            radial-gradient(circle at 54% 61%, white 1px, transparent 1px),
                            radial-gradient(circle at 31% 74%, white 1px, transparent 1px),
                            radial-gradient(circle at 92% 47%, white 0.75px, transparent 0.75px),
                            radial-gradient(circle at 67% 82%, white 1px, transparent 1px),
                            radial-gradient(circle at 44% 14%, #e8e8e8 1.25px, transparent 1.25px),
                            radial-gradient(circle at 10% 51%, white 0.75px, transparent 0.75px)`,
          backgroundRepeat: 'repeat',
          backgroundSize: '450px 380px',
          filter: 'drop-shadow(0 0 12px rgba(255,255,255,0.6)) drop-shadow(0 0 6px rgba(255,255,255,0.4))',
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'linear-gradient(180deg, rgba(10, 10, 30, 0) 0%, rgba(15, 20, 60, 0) 15%, rgba(25, 35, 90, 0.3) 30%, rgba(50, 40, 100, 0.6) 45%, rgba(120, 60, 80, 0.8) 55%, rgba(180, 80, 40, 0.95) 70%, rgba(220, 120, 30, 1) 85%, rgba(240, 140, 20, 1) 100%)',
        zIndex: 0
      }} />
      <Plane />

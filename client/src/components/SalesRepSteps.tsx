...
export const SalesRepSteps = () => {
  ...
  return (
    ...
    >
      ...
      {/* Intro Section */}
      <section className="flex items-center justify-center relative overflow-hidden" style={{ height: '4vh' }}>
        <motion.div 
        ...
        >
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-0 text-white drop-shadow-lg">
      ...
      {/* Step Carousel */}
      <section className="relative py-0 -mt-12">

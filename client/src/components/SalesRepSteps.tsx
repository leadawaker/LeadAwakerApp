  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 200% 120% at 50% 115%, rgba(59, 130, 246, 0.7) 0%, rgba(37, 99, 235, 0.6) 15%, rgba(29, 78, 216, 0.45) 35%, rgba(30, 58, 138, 0.2) 55%, rgba(30, 58, 138, 0) 100%)',
        zIndex: 0
      }} />
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 220% 150% at 50% 110%, rgba(96, 165, 250, 0.7) 0%, rgba(59, 130, 246, 0.55) 25%, rgba(37, 99, 235, 0.25) 50%, rgba(30, 58, 138, 0) 100%)',
        zIndex: 0
      }} />
      <Plane />

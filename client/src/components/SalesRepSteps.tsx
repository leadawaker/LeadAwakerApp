    ...
    >
      ...
      <section className="py-32 md:py-40">
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent drop-shadow-lg" style={{ filter: 'drop-shadow(0 0 20px rgba(59, 130, 246, 0.25)) drop-shadow(0 0 35px rgba(249, 115, 22, 0.25))', perspective: '1200px' }}>Manual reactivation is <motion.span initial={{ opacity: 0, rotateX: -90, y: -20 }} whileInView={{ opacity: 1, rotateX: 0, y: 0 }} transition={{ duration: 0.7, delay: 0.2, ease: "easeOut" }} viewport={{ once: true }} style={{ background: 'linear-gradient(135deg, rgba(254, 184, 0, 0.2) 0%, rgba(234, 152, 44, 0.15) 100%)', paddingBottom: '0.125rem', borderBottom: '2px solid rgba(254, 184, 0, 0.6)', borderRadius: '2px', display: 'inline-block', transformStyle: 'preserve-3d' }}>broken</motion.span>.</h2>
          </motion.div>

...
export const SalesRepSteps = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 pointer-events-none z-[5]" style={{
      ...
      <div className="absolute inset-x-0 bottom-0 pointer-events-none z-[1] h-[500px] overflow-hidden opacity-80">
        <motion.div 

...
export const SalesRepSteps = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 300% 200% at 50% 90%, rgba(253, 183, 0, 0.9) 0%, rgba(249, 115, 22, 0.8) 5%, rgba(147, 112, 219, 0.4) 12%, rgba(0, 168, 232, 0.7) 25%, rgba(0, 50, 100, 0.9) 38%, rgba(0, 0, 0, 1) 55%, rgba(0, 0, 0, 1) 100%)',
        zIndex: 2
      }} />
      <Plane />

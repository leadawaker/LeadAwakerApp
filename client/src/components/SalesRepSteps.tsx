  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 200% 120% at 50% 100%, rgba(220, 180, 255, 0.7) 0%, rgba(180, 130, 240, 0.6) 15%, rgba(130, 100, 220, 0.45) 35%, rgba(80, 60, 180, 0.2) 55%, rgba(40, 50, 120, 0) 100%)',
        zIndex: 0
      }} />
      <div className="absolute inset-0 pointer-events-none sm:opacity-100 opacity-80" style={{
        background: 'radial-gradient(ellipse 350% 200% at 50% 100%, rgba(249, 158, 31, 0.85) 0%, rgba(249, 158, 31, 0.6) 20%, rgba(130, 80, 150, 0.25) 50%, rgba(40, 50, 120, 0) 100%)',
        zIndex: 0
      }} />
      <Plane />

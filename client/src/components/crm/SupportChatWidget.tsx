    ...
    <>
      ...
      >
          ...
          <>
            ...
            {(doodleConfig.bgStyle === "social1" || !doodleConfig.bgStyle) && (
              <>
                ...
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_67%_70%_at_1%_9%,rgba(169,255,208,0.5)_0%,transparent_64%)]" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_137%_105%_at_0%_100%,rgba(244,231,137,0.4)_0%,transparent_69%)]" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_78%_59%_at_1%_9%,rgba(199,255,235,0.89)_0%,transparent_100%)]" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_169%_148%_at_91%_15%,rgba(244,231,137,0.38)_0%,transparent_66%)]" />
              </>
            )}
            {doodleConfig.bgStyle === "social2" && (
              <>
                <div className="absolute inset-0 bg-white dark:bg-card" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_200%_132%_at_96%_12%,rgba(209,255,158,0.62)_0%,transparent_64%)]" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_151%_142%_at_0%_100%,#6ed4d8_0%,transparent_69%)]" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_130%_126%_at_0%_0%,#a5ffcb_0%,transparent_60%)]" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_183%_155%_at_100%_100%,rgba(217,217,128,0.5)_0%,transparent_66%)]" />
              </>
            )}
        ...
        <div className="relative flex flex-col h-full overflow-hidden">
          ...
          {/* ── Escalation notice ── */}
          {escalated && (
            <div className="px-3.5 py-2 border-t border-border/20 bg-orange-50 dark:bg-orange-950/20 shrink-0">

    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 ${
          scrolled
            ? "backdrop-blur-md border-b border-slate-200 dark:border-white/[0.08] shadow-sm py-4"
            : "py-6"
        }`}
        style={{ backgroundColor: '#dad5c7' }}
      >
        <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
          ...
          >
            <img src="/logo-header.svg" alt="Lead Awaker Logo" className="h-12 md:h-14 object-contain" data-testid="img-navbar-logo" />
          </button>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            {isLoggedIn ? (
              ...
              <>
                <a href="/login" className={`text-[15px] font-bold transition-colors hover:text-primary ${
      ...
      {isOpen && (
        <div
          className="md:hidden fixed left-0 right-0 backdrop-blur-lg border-b border-slate-200 dark:border-white/[0.08] p-4 flex flex-col gap-2 shadow-xl z-40"
          style={{ top: scrolled ? "68px" : "80px", backgroundColor: '#dad5c7' }}
        >

    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 backdrop-blur-md ${
          scrolled
            ? "border-b border-white/40 shadow-sm py-2"
            : "py-3"
        }`}
      ...
      >
        <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
          ...
          >
            <img src="/4.SideLogo.svg" alt="Lead Awaker Logo" className="h-8 md:h-9 object-contain" data-testid="img-navbar-logo" />
          </button>
      ...
      {isOpen && (
        <div
          ...
          style={{ top: scrolled ? "52px" : "60px", backgroundColor: 'rgba(255,255,255,0.92)' }}
        >

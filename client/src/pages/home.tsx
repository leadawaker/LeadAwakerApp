          ...
          >
            ...
            <div className="max-w-3xl mx-auto mb-12">
              <div className="relative pl-6 py-1 border-l-4 border-[#FEB800] text-left">
                <p className="md:text-[18px] text-[#FEB800] opacity-90 text-[19px] text-left font-medium">If a picture is worth a thousand words, a live demo is worth a thousand pictures.</p>
              </div>
            </div>

...
export default function BookDemo() {
  ...
  return (
    <div className="min-h-screen pb-20 bg-[#F9FAFC] -mt-32 pt-32 flex items-center">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            <h1 className="text-[40px] md:text-[52px] font-bold leading-tight tracking-tight mb-6">
              {t("hero.title")}
            </h1>

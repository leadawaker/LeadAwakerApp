...
import AnimatedCounter, { AnimatedRangeCounter } from "../components/04-Counters";
import StepsSection from "../components/02-StepsSection";
import Calculator from "../components/05-Calculator";
import DemoSection from "../components/06-DemoSection";
import WorkflowSection from "../components/07-WorkflowSection";
...
export default function Home() {
  ...
  return (
    <div className="legacy-app min-h-screen pt-32 overflow-x-clip md:overflow-visible bg-[var(--bg-primary)] dark:bg-background">
      {/* Hero Section */}
      <section className="relative overflow-x-clip pb-20 md:pb-32 bg-[var(--bg-primary)] dark:bg-background">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
              ...
              ">
                ...
                >
                  <motion.span
                    ...
                    style={{
                      background:
                        "linear-gradient(to right, transparent 0%, var(--brand-yellow) 15%, var(--brand-yellow) 70%, rgba(255,255,255,0.6) 85%, transparent 100%)",
                      left: "calc(50% - 200vw)",
                      width: "400vw",
                    }}
                    initial={{ scaleX: 0 }}
              ...
              >
                ...
                <span className="font-semibold text-[var(--brand-yellow)]">{t("hero.subtitle.line2")}</span>
              </motion.p>
              ...
              >
                <a href="#audit">
                  <Button size="lg" className="h-14 px-8 text-lg rounded-full transition-all duration-200 hover:bg-[var(--brand-yellow)] hover:text-[var(--brand-on-yellow)] hover:border-[var(--brand-yellow)] hover:[box-shadow:0_0_40px_12px_var(--brand-yellow-glow)]">
                    {t("hero.cta.primary")}
                ...
                <a href="#demo">
                  <Button
                    size="lg"
                    variant="outline"
                    className="h-14 px-8 text-lg rounded-full transition-all duration-200 hover:bg-[var(--brand-yellow)] hover:text-[var(--brand-on-yellow)] hover:border-[var(--brand-yellow)] hover:[box-shadow:0_0_40px_12px_var(--brand-yellow-glow)]"
                  >
      ...
      {/* Conversion Pipeline */}
      <section className="py-48 bg-[var(--bg-secondary)] dark:bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
      ...
      <section className="pb-48 pt-16 bg-[var(--bg-secondary)] dark:bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-lg md:text-xl mt-4 text-[var(--brand-blue-mid)]">
              {t("results.subtitle")}
            </p>
          </motion.div>
          ...
          <div className="flex flex-col gap-6 mb-12 max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              animate={{ 
                backgroundColor: isFinished ? "var(--brand-blue-deep)" : "#ffffff",
                color: isFinished ? "#ffffff" : "var(--brand-blue-mid)"
              }}
              transition={{ duration: 0.5 }}
              className="p-8 rounded-2xl border border-border text-center flex flex-col justify-center min-h-[420px] relative overflow-hidden bg-[var(--brand-blue-dark)]"
            >
              <AnimatePresence>
                {isFinished && (
                  <motion.div 
      ...
      <div className="wave-separator">
        <svg className="wave-back" viewBox="0 0 2880 92" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,35 C320,92 640,0 960,46 C1280,92 1600,12 1920,52 C2240,92 2560,23 2880,46 L2880,92 L0,92 Z" fill="var(--bg-wave-back)"/>
        </svg>
        <svg className="wave-front" viewBox="0 0 2880 92" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,12 C360,92 720,0 1080,58 C1440,92 1800,6 2160,52 C2520,92 2700,23 2880,40 L2880,92 L0,92 Z" fill="var(--bg-tertiary)"/>
        </svg>
      </div>
      ...
      <section className="py-48 bg-[var(--bg-tertiary)] dark:bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            ...
            <div className="max-w-3xl mx-auto mb-10">
              <div className="relative pl-6 py-1 border-l-4 border-[var(--brand-yellow)] text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a href={t("bottomCta.waLink")} target="_blank" rel="noopener noreferrer">
                <Button
                  size="lg"
                  className="h-14 px-10 text-lg rounded-full shadow-xl shadow-primary/20 bg-white text-primary transition-all duration-200 font-bold hover:bg-[var(--brand-yellow)] hover:text-[var(--brand-on-yellow)] hover:border-[var(--brand-yellow)] hover:[box-shadow:0_0_40px_12px_var(--brand-yellow-glow)]"
                >
                  {t("bottomCta.button")}
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>

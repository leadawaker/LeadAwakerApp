...
export function StepsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 pointer-events-none [background:linear-gradient(to_bottom,transparent_0%,var(--bg-secondary)_100%)] dark:[background:linear-gradient(to_bottom,transparent_0%,hsl(var(--background))_100%)]" style={{ height: '25vh', zIndex: 5 }} />

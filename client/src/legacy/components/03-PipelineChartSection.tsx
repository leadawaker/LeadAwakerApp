...
export default function PipelineChart() {
  ...
  const STAGES: Stage[] = [
    ...
    },
    {
      ...
      colorClass: "border-[var(--brand-yellow)]/30 text-[var(--brand-on-yellow)]",
      headerClass: "text-[var(--brand-on-yellow)]",
      textColorClass: "text-[var(--brand-on-yellow)]",
      customStyle: { backgroundColor: "var(--brand-yellow)" },
      customTextStyle: { color: "var(--brand-yellow)" },
    },
  ];

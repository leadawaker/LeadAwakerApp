...
const ALL_TABLE_COLUMNS: ColumnDef[] = [
  { key: "name",            tKey: "columns.accountName", width: 200, editable: false, type: "text"   },
  { key: "status",          tKey: "columns.status",      width: 130, editable: true,  type: "select" },
  { key: "type",            tKey: "columns.type",        width: 120, editable: false, type: "text"   },
  { key: "owner_email",     tKey: "columns.ownerEmail",  width: 190, editable: true,  type: "text"   },
  { key: "phone",           tKey: "columns.phone",       width: 140, editable: true,  type: "text"   },
  { key: "business_niche",  tKey: "columns.niche",       width: 160, editable: true,  type: "text"   },
  { key: "website",         tKey: "columns.website",     width: 160, editable: true,  type: "text"   },
  { key: "timezone",        tKey: "columns.timezone",    width: 160, editable: false, type: "text"   },
  { key: "max_daily_sends", tKey: "columns.dailySends",  width: 110, editable: false, type: "text"   },
  { key: "notes",           tKey: "columns.notes",       width: 200, editable: true,  type: "text"   },
];
  ...
  return (
    <div className="p-3 space-y-1.5">
      ...
      {Array.from({ length: 10 }).map((_, i) => (
        <div
          key={i}
          className="h-9 bg-primary/10 rounded-xl animate-pulse"
            ...
            <tbody>
                  ...
                  <td colSpan={colSpan + 1} className="py-12 text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {tableSearch ? t("page.noAccountsMatch") : t("page.noAccountsFound")}
                      </p>
                    </div>
                  </td>
                </tr>
              ...
              {(() => {
                ...
                return displayItems.map((item, index) => {
                  ...
                  const name = String(account.name || t("related.unnamed"));

  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {isEditMode ? t("invoices.form.editInvoice") : t("invoices.form.createInvoice")}
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label htmlFor="inv-title">{t("invoices.form.title")}</Label>
              <Input
                id="inv-title"
            ...
            {isAgencyUser && (
              <div className="space-y-1.5">
                <Label htmlFor="inv-account">{t("invoices.form.account")}</Label>
                <Select
                  value={accountId}
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="inv-issued">{t("invoices.form.issueDate")}</Label>
              <Input
                id="inv-issued"
                type="date"
                value={issuedDate}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="inv-tax">{t("invoices.form.taxPercent")}</Label>
                <Input
                  id="inv-tax"
                  type="number"
                  min={0}
              ...
              <div className="space-y-1.5">
                <Label htmlFor="inv-discount">{t("invoices.form.discountAmount")}</Label>
                <Input
                  id="inv-discount"
                  type="number"
                  min={0}
            ...
            <div className="flex flex-col justify-end space-y-1 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-muted-foreground">
                  {t("invoices.detail.taxWithPercent", { percent: taxPercent })}
                </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="inv-payment">{t("invoices.form.paymentInfo")}</Label>
              <Textarea
                id="inv-payment"
                placeholder={t("invoices.form.paymentInfoPlaceholder")}
                rows={3}
                value={paymentInfo}

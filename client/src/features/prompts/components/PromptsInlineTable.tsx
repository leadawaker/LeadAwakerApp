              ...
              return (
                <td key={col.key} className="px-3" style={{ width: col.width, minWidth: col.width }}>
                  <button
                    ...
                    title={(p.status || "").toLowerCase() === "active" ? t("detail.clickToArchive") : t("detail.clickToActivate")}
                  ...
                  >
                    ...
                    {t(STATUS_I18N_KEY[(p.status || "").toLowerCase().trim()] ?? "status.unknown")}
                  </button>
                </td>
              );

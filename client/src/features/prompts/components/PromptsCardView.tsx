...
/* ── Module-level i18n key map (data-as-labels pattern) ─────────────────── */
...
function EditPanel({
  ...
  async function handleSave() {
    ...
    try {
      ...
      toast({ title: t("toast.saveFailed"), description: err.message || "Unknown error", variant: "destructive" });
    } finally {
      setSaving(false);
    }
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Prompt Text */}
      <div>
        <label className={labelCls}>{t("form.promptText")} *</label>
        <textarea
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className={labelCls}>{t("form.systemMessage")}</label>
          <textarea
            ...
            placeholder={t("form.systemMessagePlaceholderShort")}
          />
        </div>
        <div>
          ...
          <textarea
            ...
            placeholder={t("form.notesPlaceholderShort")}
          />
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="font-semibold text-[13px] text-foreground leading-snug truncate">
                {p.name || <span className="text-muted-foreground italic">{t("labels.untitled")}</span>}
              </div>
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                >
                  ...
                  {t(STATUS_I18N_KEY[(p.status || "").toLowerCase()] ?? "status.unknown")}
                </span>

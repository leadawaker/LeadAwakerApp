...
export const TAG_TABLE_COLUMNS: {
  ...
  { key: "name",        label: "Tag Name",    tKey: "columns.name",        width: 180, defaultVisible: true  },
  { key: "category",    label: "Category",    tKey: "columns.category",    width: 120, defaultVisible: true  },
  { key: "account",     label: "Account",     tKey: "columns.account",     width: 150, defaultVisible: true  },
  { key: "campaign",    label: "Campaign",    tKey: "columns.campaign",    width: 150, defaultVisible: true  },
  { key: "leadCount",   label: "Leads",       tKey: "columns.leadCount",   width: 70,  defaultVisible: true  },
  { key: "description", label: "Description", tKey: "columns.description", width: 200, defaultVisible: true  },
  { key: "autoApplied", label: "Auto",        tKey: "columns.autoApplied", width: 60,  defaultVisible: true  },
];

...
export const STATUS_COLORS: Record<string, { bg: string; text: string; dot: string; badge: string }> = {
  ...
  Qualified:            { bg: "bg-lime-500/10",    text: "text-lime-700 dark:text-lime-400",     dot: "bg-lime-500",    badge: "bg-lime-100 text-lime-700 border-lime-200 dark:bg-lime-900/30 dark:text-lime-300 dark:border-lime-800" },
